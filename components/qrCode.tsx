...
const QRCode = ({
  ...
  return (
    <Box height={size} userSelect="none">
      <div style={{ height: 0, position: 'relative', textAlign: 'center', top: logoPosition }}>
        <Image alt="" src={logoSrc} height={logoSize} width={logoSize} draggable="false" />
      </div>
